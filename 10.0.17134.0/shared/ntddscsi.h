...
#define IOCTL_MINIPORT_SIGNATURE_QUERY_QUEUE_INFO           "QUEUEINF"
#define IOCTL_MINIPORT_SIGNATURE_CREATE_RESERVED_QUEUE_PAIR "CREATEQU"
#define IOCTL_MINIPORT_SIGNATURE_DELETE_RESERVED_QUEUE_PAIR "DELETEQU"
